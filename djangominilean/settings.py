# Django settings for djangominilean project.
...
MEDIA_ROOT = 'djangominilean/media/'
...
SECRET_KEY = 'j(an+=$k1kkd1)%&amp;y7e!)xf7pk_7c2y4i@v23g$79(_y*%y+g$'
...
ROOT_URLCONF = 'djangominilean.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'djangominilean.wsgi.application'
